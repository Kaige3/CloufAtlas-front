    ...
    <a-table
      ...
      <template #bodyCell="{ column, record }">
        ...
        <template  v-if="column.dataIndex === 'reviewMessage'">
          <div>审核状态：{{ PIC_REVIEW_STATUS_MAPPING[record.reviewStatus] }}</div>
...
import {PIC_REVIEW_STATUS_ENUM, PIC_REVIEW_STATUS_MAPPING, PIC_REVIEW_STATUS_OPTIONS} from "@/constants/picture";
