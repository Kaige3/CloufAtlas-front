...
/** batchEditePicture POST /api/picture/edit/batch */
...
/** listPictureVoByPageWithCaffeineCache POST /api/picture/list/page/vo/Caffeinecache2 */
export async function listPictureVoByPageWithCaffeineCacheUsingPost(
  body: API.PictureQueryDto,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>(
    "/api/picture/list/page/vo/Caffeinecache2",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
/** listPictureVoByPageWithCaffeineCacheAndRedis POST /api/picture/list/page/vo/Caffeinecache3 */
export async function listPictureVoByPageWithCaffeineCacheAndRedisUsingPost(
  body: API.PictureQueryDto,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePagePictureVO_>(
    "/api/picture/list/page/vo/Caffeinecache3",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
/** searchPicture POST /api/picture/search/picture */
export async function searchPictureUsingPost(
  body: API.SearchPictureByPictureDto,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListSoImageSearchDto_>(
...
/** getTagAndCategory GET /api/picture/tag_category */
